    ...
    <TD background=secondhand_files/bj.jpg align=middle>
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=800>
       ...
       <jsp:include page="top.jsp"></jsp:include>
        ...
        PageManager pageManager = PageManager.getPage("gfcs.jsp?1=1",8, request);
	    pageManager.doList("select * from hbnews where title like'%"+key+"%'  order by id desc");
