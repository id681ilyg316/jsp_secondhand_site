    ...
    <TD background=secondhand_files/bj.jpg align=middle>
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=800>
       ...
       <jsp:include page="top.jsp"></jsp:include>
          ...
          <TD vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                ...
                </div><form  action="fwxx.jsp?f=f&tglparentid=<%=tglparentid%>"  onSubmit="return checkform()"  name="f1" ><div align="left"> 
                </div><TABLE 
        ...
        PageManager pageManager = PageManager.getPage("fwxx.jsp",5, request);
         
	    pageManager.doList("select * from secondhand where infotype='淘宝专区' and uname like '%"+ukey+"%'  and  title like'%"+key+"%'   order by id desc");
...
function update(no){ 
popheight="300";
pop('admin/secondhandxg.jsp?id='+no,'信息修改',550,360) 
}
</script> 
