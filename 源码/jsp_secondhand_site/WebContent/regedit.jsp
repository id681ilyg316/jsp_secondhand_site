...
<TR>
                              ...
                              <TD class=css height=32 
                                background=secondhand_files/ny_xt.jpg width="77%" 
                                align=left>
                                 <input type=password  class='' id='userpass' name='userpass' size=35 /><label id='clabeluserpass' /> </TD>
                            </TR>
<TR>
                              <TD class=css height=32 
                                background=secondhand_files/ny_xt.jpg width="23%" 
...
<TR>
                              <TD class=css height=32 
                                background=secondhand_files/ny_xt.jjpg width="23%" 
                                align=center>头像</TD>
                              <TD class=css height=32 
...
if(usernameobj.value!=""){  
var ajax = new AJAX();
ajax.post("/secondhand_site/factory/checkno.jsp?table=users&col=username&value="+usernameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
