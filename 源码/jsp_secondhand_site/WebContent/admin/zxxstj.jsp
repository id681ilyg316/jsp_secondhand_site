...
%>
<body>
<form  action="zxxstj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 添加二手交易信息&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">价格</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
...
var wptypeobj = document.getElementById("wptype");  
if(wptypeobj.value==""){  
document.getElementById("clabelwptype").innerHTML="&nbsp;&nbsp;<font color=red>请输入类别</font>";  
return false;  
}else{
document.getElementById("clabelwptype").innerHTML="  ";  
}  
