...
new CommDAO().update(request,response,"juanz",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"juanz"); 
%>
<body>
<form  action="juanzxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 修改捐赠信息&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
<script src=/secondhand_site/js/My97DatePicker/WdatePicker.js></script>
<script src=/secondhand_site/js/popup.js></script>
<script src=/secondhand_site/js/ajax.js'></script>
