...
<body>
	<form action="membercx.jsp" name="f1" method="post">
		<table width="99.8%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
			...
			<tr>
				<td><table width="100%" border="0" cellpadding="0"
						cellspacing="1" class="mytab" onmouseover="changeto()"
						onmouseout="changeback()">

						<tr>
							<td colspan=11 height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19"><label></label>&nbsp;&nbsp;&nbsp; <%
 	String pusername = request.getParameter("username") == null ? "" : request.getParameter("username");
 	String startusername = request.getParameter("startusername") == null
 			? ""
 			: request.getParameter("startusername");
 	...
 	String starttruename = request.getParameter("starttruename") == null
 			? ""
 			: request.getParameter("starttruename");
 	String endtruename = request.getParameter("endtruename") == null ? "" : request.getParameter("endtruename");
 %> <%
 	HashMap mmm = new HashMap();
 %> &nbsp;&nbsp;用户名 &nbsp;:&nbsp; <input
								type=text class='' size=15 name='username' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;姓名 &nbsp;:&nbsp; <input type=text class='' size=15
								name='truename' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tr bgcolor="#F3F8F7">
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">用户名</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">姓名</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">性别</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">QQ</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">电话号码</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">email</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">家道地址</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">用户类别</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7; color: #344B50;">注册时间</td>
							<td height="30" align="center"
						...
						<%
							...
							if(type!=null&&type.equals("reset")){
								new CommDAO().pwdReset(request, "users");
						...
						<tr>
							...
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
								...
								<a href="membercx.jsp?type=delete&scid=<%=map.get("id")%>">删除</a>&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="membercx.jsp?type=reset&scid=<%=map.get("id")%>">密码重置</a>
							</td>
						</tr>
						<%
							}
...
<%=Info.tform(mmm)%>
<script language=javascript
	src='/secondhand_site/js/My97DatePicker/WdatePicker.js'></script>
<script language=javascript src='/secondhand_site/js/popup.js'></script>
<script language=javascript> 
function update(no){ 
