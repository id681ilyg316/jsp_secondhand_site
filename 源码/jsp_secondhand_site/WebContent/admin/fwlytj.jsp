...
ext.put("saver",Info.getUser(request).get("username")); 
new CommDAO().insert(request,response,"fwly",ext,true,false); 
%>
<body>
<form  action="fwlytj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" onSubmit="return checkform()">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <input type=text  class='' id='title' name='title' size=55 />
        <label id='clabeltitle' /></td>
        </tr>
<tr>
        <td height="15" colspan="2" align="center" bgcolor="#FFFFFF" class="STYLE19"><strong>请输入内容</strong></td>
        </tr>
<tr>
  <td height="15" colspan="2" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=Info.fck(265,"")%></td>
  </tr>
