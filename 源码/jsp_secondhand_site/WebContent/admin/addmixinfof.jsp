...
<script type="text/javascript"  src="/secondhand_site/fckeditor/fckeditor.js"></script>
 <script language="javascript">
 function fckinit()
 {
   var of = new FCKeditor("content");
		of.BasePath="/secondhand_site/fckeditor/";
		of.Height = "300";
...
<body onload="fckinit();">
<form action="/secondhand_site/secondhand?ac=addmixinfof" name="f1" >
