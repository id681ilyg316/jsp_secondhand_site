...
<script languagesecondhandpt src='/greensite/js/My97DatePicker/WdatePicker.js'></script>
<script languagsecondhandipt src='/greensite/js/popup.js'></script>
<script languasecondhandript src='/greensite/js/ajax.js'></script>
