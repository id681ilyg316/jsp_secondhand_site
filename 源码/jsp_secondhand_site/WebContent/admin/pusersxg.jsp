...
%>
<body>
<form  action="pusersxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
...
if(usernameobj.value!=""){  
var ajax = new AJAX(); 
ajax.post("/secondhand_site/factory/checkno.jsp?table=users&col=username&value="+usernameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
