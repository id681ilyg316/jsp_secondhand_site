...
ext.put("usertype","会员"); 
new CommDAO().update(request,response,"users",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"users"); 
%>
<body>
<form  action="memberxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 修改用户信息&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">登录密码</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
...
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">家道地址</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
        <input type=text  class='' id='dizhi' name='dizhi' size=35 /><label id='clabeldizhi' /></td>
        </tr>
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">相片</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!="")secondhand ajax = new AJAX(); 
ajax.post("/greensite/factory/checkno.jsp?table=users&col=username&value="+usernameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
...
document.getElementById("clabeluserpass").innerHTML="&nbsp;&nbsp;<font color=red>请输入登录密码</font>";  
return false;  
}else{ 
