...
<body>
<form  action="userscx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 管理员信息维护</span></td>
              </tr>
            </table></td>
            <td> 
...
<td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;" >密码</td>
...
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;" >家庭住址</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;" >保存时间</td>
...
String sql = "select * from users where 1=1 " ;
 ...
 sql+= " and truename <'"+Info.getDay(endtruename,1)+"' " ;
  ...
  sql +="  and (1!=1 " ; 
  sql +="  or  usertype like'%管理员%' " ;
  sql +="  ) ";
  sql +=" order by id desc ";
String url = "userscx.jsp?1=1&username="+pusername+"&truename="+ptruename+""; 
ArrayList<HashMap> list = PageManager.getPages(url,5, sql, request ); 
for(HashMap map:list){ %>
<tr>

        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("username")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("userpass")%></td>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a href="javascript:update('<%=map.get("id")%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="userscx.jsp?scid=<%=map.get("id")%>">删除</a></td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('usersxg.jsp?id='+no,'信息修改',550,379) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('userstj.jsp','信息添加',550,379) 
}
</script> 
<%@page import="util.Info"%> 
