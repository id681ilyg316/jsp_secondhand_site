...
<body>
<form  action="secondhandcx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 淘宝专区管理</span></td>
              </tr>
            </table></td>
            <td> 
...
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;" >物品价格</td>
...
String sql = "select * from secondhand where infotype='淘宝专区' " ;
 if(!ptitle.equals("")){ 
...
String url = "secondhandcx.jsp?1=1&title="+ptitle+"&uname="+puname+""; 
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a href="javascript:update('<%=map.get("id")%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="secondhandcx.jsp?scid=<%=map.get("id")%>">删除</a></td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('secondhandxg.jsp?id='+no,'信息修改',550,360) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('secondhandtj.jsp','信息添加',550,360) 
}
</script> 
<%@page import="util.Info"%> 
