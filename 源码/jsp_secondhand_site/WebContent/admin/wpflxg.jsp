...
new CommDAO().update(request,response,"wpfl",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"wpfl"); 
%>
<body>
<form  action="wpflxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 修改分类&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
if(typenameobj.value!=""){  
var ajax = new AJAX(); 
ajax.post("/secondhand_site/factory/checkno.jsp?table=wpfl&col=typename&value="+typenameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
