...
%>
<body>
<form  action="yqljxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 修改链接&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
if(ljnameobj.value!=""){  
var ajax = new AJAX(); 
ajax.post("/secondhand_site/factory/checkno.jsp?table=yqlj&col=ljname&value="+ljnameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
