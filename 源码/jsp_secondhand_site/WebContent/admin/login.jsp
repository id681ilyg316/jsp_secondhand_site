...
<HTML><HEAD><TITLE>大学二手交易网后台管理 - 登 录</TITLE>
<META content="MSHTML 6.00.6000.16809" name=GENERATOR></HEAD>
<BODY onLoad="loginform.uname.focus();" background="/secondhand_site/admin/images/bj.gif">


<script type="text/javascript" src="/secondhand_site/admin/images/popup.js"></script>
...
<P>&nbsp;</P>
<P>&nbsp;</P>
<FORM name=loginform action="/secondhand_site/secondhand?ac=login"
method=post>
  <table id=Table1 
...
cellspacing=0 cellpadding=0 width=380 align=center>
    ...
    style="PADDING-RIGHT: 3px; PADDING-LEFT: 3px; FONT-SIZE: 13px; PADDING-BOTTOM: 3px; COLOR: white; PADDING-TOP: 3px; BACKGROUND-COLOR: blue">用户登录　　　　</td>
      ...
      <tr valign=top>
        <td><img height=60 src="/secondhand_site/admin/images/admin_title.gif" width=378></td>
      </tr>
      <tr>
        <td height="60" 
...
session.removeAttribute("suc");
 ...
 %>
      ...
      <tr>
        <td height="33" 
    align=right 
    style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FONT-SIZE: 13px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px">后台管理 </td>
      </tr>
    </tbody>
  </table>
