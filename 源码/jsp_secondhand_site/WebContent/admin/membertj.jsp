...
%>
<body>
<form  action="membertj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 添加注册用户&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!="")secondhandajax = new AJAX();
