...
<body>
<form  action="hbnewscx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 优惠活动管理</span></td>
              </tr>
            </table></td>
            <td> 
...
&nbsp;&nbsp;新闻标题 &nbsp;:&nbsp; <input type=text class=''  size=15 name='title' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;作者 &nbsp;:&nbsp; <input type=text class=''  size=15 name='author' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;<input type=submit class='' value='查询信息' /> &nbsp;&nbsp;<input type=button   class='' value='添加信息' onclick="window.location.replace('hbnewstj.jsp')" /> &nbsp;&nbsp;</td>
        </tr>
      
      
      <tr bgcolor="#F3F8F7">
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;" >新闻标题</td>
<td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;" >作者</td>
...
String sql = "select * from hbnews where 1=1 " ;
 if(!ptitle.equals("")){ 
...
String url = "hbnewscx.jsp?1=1&title="+ptitle+"&author="+pauthor+""; 
ArrayList<HashMap> list = PageManager.getPages(url,5, sql, request ); 
for(HashMap map:list){ %>
<tr>

        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("title")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("author")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("savetime")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a href="hbnewsxg.jsp?id=<%=map.get("id")%>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="hbnewscx.jsp?scid=<%=map.get("id")%>">删除</a></td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('hbnewsxg.jsp?id='+no,'信息修改',500,280) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('hbnewstj.jsp','信息添加',500,280) 
}
</script> 
<%@page import="util.Info"%> 
