...
<body>
<form  action="ywywcx.jsp"  name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 物品租借管理</span></td>
              </tr>
            </table></td>
            <td> 
...
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >新旧度</td>
...
String sql = "select * from secondhand where 1=1 " ;
 ...
 sql+= " and uname <'"+Info.getDay(enduname,1)+"' " ;
  ...
  sql +="  and (1!=1 " ; 
  sql +="  or  infotype like'%物品租借%' " ;
  sql +="  ) ";
  sql +=" order by id desc ";
String url = "ywywcx.jsp?1=1&title="+ptitle+"&uname="+puname+""; 
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a href="javascript:update('<%=map.get("id")%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="ywywcx.jsp?scid=<%=map.get("id")%>">删除</a></td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('ywywxg.jsp?id='+no,'信息修改',550,391) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('ywywtj.jsp','信息添加',550,391) 
}
</script> 
<%@page import="util.Info"%> 
