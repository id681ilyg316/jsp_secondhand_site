...
<% 
new CommDAO().delete(request,"zdatadic"); 
String id = "3"; 
String erjitype = request.getParameter("erjitype"); 
String myztree = request.getParameter("myztree"); 
HashMap ext = new HashMap(); 
ext.put("datatype","关于我们"); 
new CommDAO().update(request,response,"zdatadic",ext,true,false); 
HashMap mmm = new CommDAO().getmap(id,"zdatadic"); 
%>
<body>
<form  action="gywm.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 关于我们&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width=" " height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"> 
        <%=Info.fck(265,mmm.get("content").toString())%></td>
        </tr>
