...
ext.put("resaver",Info.getUser(request).get("username"));
...
%>
<body>
<form  action="messageshf.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 留言回复&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
