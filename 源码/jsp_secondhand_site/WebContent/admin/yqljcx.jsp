          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 友情链接</span></td>
              </tr>
            </table></td>
            <td> 
...
&nbsp;&nbsp;链接名称 &nbsp;:&nbsp; <input type=text class=''  size=20 name='ljname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("ljname")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("ljurl")%></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a href="javascript:update('<%=map.get("id")%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a onclick="return confirm('确定要删除这条记录吗?')"  href="yqljcx.jsp?scid=<%=map.get("id")%>">删除</a></td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('yqljxg.jsp?id='+no,'信息修改',550,126) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('yqljtj.jsp','信息添加',550,126) 
}
</script> 
<%@page import="util.Info"%> 
