...
<body>
<form  action="sprosorderspcx.jsp"  name="f1" method="post">
...
&nbsp;<input type=submit class='' value='查询信息' /> &nbsp; &nbsp; &nbsp; <br /></td>
      ...
      <tr bgcolor="#F3F8F7">
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >卖家</td>
...
String sql = "select * from prosorders where 1=1 " ;
 ...
 sql+= " and ddinfo <'"+Info.getDay(endddinfo,1)+"' " ;
  ...
  sql +="  and (1!=1 " ; 
  sql +="  or  uname like'%"+uname+"%' " ;
  sql +="  ) ";
  sql +=" order by id desc ";
String url = "sprosorderspcx.jsp?1=1&uname="+puname+"&ddinfo="+pddinfo+""; 
ArrayList<HashMap> list = PageManager.getPages(url,5, sql, request ); 
for(HashMap map:list){ %>
<tr>

        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("touname")%></td>
