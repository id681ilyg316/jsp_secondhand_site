...
new CommDAO().update(request,response,"secondhand",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"secondhand"); 
%>
<body>
<form  action="ywywxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 修改物品租借信息&nbsp;&nbsp;</span></td>
              </tr>
            </table></td>
            <td> 
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce"  class="mytab" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <input type=text  class='' id='title' name='title' size=35 /><label id='clabeltitle' /></td>
         ...
         <tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">物品类别</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
        <%=Info.getselect("wptype","wpfl","typename","1=1") %><label id='clabelwptype' /></td>
        </tr>
...
<tr>
        <td width="21%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">新旧度</td>
        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
        <input type=text  class='' id='price' name='price' size=35 /><label id='clabelprice' /></td>
        </tr>
<tr>
...
if(priceobj.value==""){  
document.getElementById("clabelprice").innerHTML="&nbsp;&nbsp;<font color=red>请输入新旧度</font>";  
return false;  
}else{ 
