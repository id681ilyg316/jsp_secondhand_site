...
var ajax = new AJAX();
ajax.post("/secondhand_site/secondhand?ac=gethouses&louno="+louno);
...
<%
 ...
 %>
<form action="/secondhand_site/huif.jsp?id=<%=id %>&f=f" name="f1" >
...
%>
alert("操作成功");
parent.location.replace("/secondhand_site/admin/sysuser.jsp");
<%}%>
</script>
