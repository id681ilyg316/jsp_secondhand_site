...
<TD vAlign=top width=196>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD background="secondhand_files/index_zlm.jpg" height="35" align="left">
                      <font color="white"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户登录</strong></font></TD></TR>
                    <TR>
                      <TD background=secondhand_files/index_zlmbj.jpg 
                        align=middle>
                        
                          <form name="form1" action="/secondhand_site/secondhand?ac=mlogin">
                        ...
                        width="90%" align=center>
                          ...
                          <TR>
                            ...
                            background=secondhand_files/index_dx.jpg 
                          align=left></TD></TR>
                          ...
                          window.location.replace("/secondhand_site");
                          </script>
                          <%
                          }
                           %>
                        ...
                        if(umap==null){
                         %>
                          ...
                          <TR>
                            <TD class=css height=33 
                              align=center>密&nbsp;码:
                              <input type="password" name="upass" id="upass"  size="12" style="height:13px"></TD>
                          </TR>
...
<input type="button" value="注册" style="border:2px" onClick="window.location.replace('regedit.jsp')" /></TD>
                    ...
                    <TR>
                      <TD align=left height="41" background="secondhand_files/index_zlm1.jpg" >
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="white">联系我们</font></strong>
                      
                      </TD></TR>
                    <TR>
                      <TD background=secondhand_files/index_zlmbj1.jpg 
                    ...
                    <TR>
                      <TD height=62 background=secondhand_files/index_zlmbj1.jpg 
                      align=middle>
                      
                      <div style="position: absolute; line-height:50px;left:310px; FONT-FAMILY:  "><font color="orange" size="4"  ><strong> 客服中心</strong></font> </div> 
                      
                      <A 
                        href="messages.jsp" ><IMG border=0 
                        src="secondhand_files/index_zlm2.jpg" width=186 
