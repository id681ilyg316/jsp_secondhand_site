        ...
        <TR>
          <TD height=70 vAlign=center align=right>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              <TBODY>
              <TR>
                <TD width="19%" height="80" rowspan="2" align="center" onClick="window.location.replace('/secondhand_site')" >
                 <img src="secondhand_files/logo.png" height="40" />                </TD>
        ...
        <TR>
          <TD height=47 vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" 
              height=40><TBODY>
              <TR>
                <TD width=16><IMG src="secondhand_files/dh_z.jpg" width=16 
                  height=40></TD>
                <TD class=bold_txt background=secondhand_files/dh_bj.jpg 
                align=middle>
                ...
                <TD width=16><IMG src="secondhand_files/dh_y.jpg" width=16 
                  height=40></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD height=160 vAlign=top width="100%">
            
            <img src="/secondhand_site/secondhand_files/background.jpg" width="799" height="160"></img>
          ...
          <TD height=34 vAlign=top>
            <TABLE width="100%" height="34" border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                <TD width=56 valign="top"><IMG src="/secondhand_site/secondhand_files/gg_zj.jpg" width=56 
                  height=34></TD>
                <TD align=left valign="middle" height="30" background=secondhand_files/gg_bj.jpg><SPAN 
                  class=css>欢迎光临本站，本站致力于大学校园二手交易事业的发展，详情请咨询 
                   
                  </SPAN></TD>
                <TD width=16  height="30" background="secondhand_files/gg_y.jpg">              </TD>
